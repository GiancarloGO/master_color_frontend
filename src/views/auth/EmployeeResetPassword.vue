        ...
        <div class="reset-password-card">
            <div class="text-center mb-5">
                <div class="logo-container mb-4">
                    <div class="w-16 h-16 bg-blue-700 rounded-xl flex items-center justify-center shadow-xl mx-auto">
                ...
                <span class="text-600 font-medium">Empleados - Crea una nueva contraseña segura para tu cuenta.</span>
            </div>
